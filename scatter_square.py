...
# using a ColorMap
ax.scatter(x_values, y_values, c = y_values, cmap = plt.cm.Blues, s = 10)  # To change the color of the points, pass c to scatter() with the name of a color ex: c='red'
...
# plt.show()
plt.savefig('squares_plot.png',bbox_inches='tight')  # Saves the figure as "square_plot.png" in the same directory where the script is present.
